@echo off
echo Please note: this application doesn't support going back to the menu.
echo If we did support it, it would kinda mess up the game. So for now if you quit the software, It would simply close this window.
pause
