@echo off
echo Please run this as an admin, if you have not already. lol
echo if you did, press any key. if you didn't, please relaunch the game and do it. this game will not run correctly without admin access
...
%plot% !TX! !TY! body
      ...
      %draw%
echo ERROR - Snake Not Found: The snake probably died.
ping localhost -n 1 >nul
echo ERROR - LOST COMPONENTS DETECTED: SHUTDOWN THE SYSTEM DOWN!
ping localhost -n 1 >nul
echo ERROR - SNAKEBSOD.BAT NOT FOUND AT 0000x0000ff0ff
ping localhost -n 1 >nul
bsod.bat
